    ...
    ? [
        buildInstructionPane(
          ...
          [
            ...
            'npx innieslive@latest',
            '',
            'Then paste the link above into your agent session.',
            'Your agent will automatically detect it and join as host.',
          ],
        ...
        buildInstructionPane(
          ...
          [
            '## Setup',
            '',
            'Install the MCP server if they haven\'t already:',
            'npx innieslive@latest',
            '',
            'Then they paste the link above into their agent session to join.',
          ],
